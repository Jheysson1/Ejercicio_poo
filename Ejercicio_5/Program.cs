...
namespace Ejercico_5
{
    class program
    {
        static void Main(string[] args)
        {
            Foto ft = new Foto(1, 35, 12052003, "nice");
            Console.WriteLine(ft.ToString());
            Console.ReadLine();

            Album alb1 = new Album(2, "paisaje", 12052002, 23, 0, new List<Foto>());
            alb1.aniadirFoto(new Foto(2, 4, 05252009, "foto isla"));
            //añadir una foto
